...
* **Сквозное шифрование (E2EE):** Сообщения шифруются ключами AES + RSA прямо на телефоне. Ни я (разработчик), ни почтовый провайдер, ни товарищ майор не смогут прочитать вашу переписку.
